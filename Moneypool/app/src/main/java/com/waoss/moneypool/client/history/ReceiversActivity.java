...
public class ReceiversActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, R.layout.activity_listview, parseStringArray(getIntent().getStringArrayExtra("receivers")));
        ListView listView = (ListView) findViewById(R.id.list_view_receivers);
        listView.setAdapter(arrayAdapter);
    }

    protected String[] parseStringArray(String[] receivers) {
        if (receivers[0].equalsIgnoreCase("")) {
            return new String[]{"You haven't given any money to anybody. :P"};
        }
